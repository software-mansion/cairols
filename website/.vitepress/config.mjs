...
export default defineConfig({
    ...
    description:
        "Cairo Language Server is an implementation of Language Server Protocol for the Cairo language.",
    lang,
    base,
    ...
    head: [
        ...
        ["meta", { name: "apple-mobile-web-app-title", content: "Cairo Language Server" }],
    ...
    themeConfig: {
        ...
        socialLinks: [
            { icon: "github", link: "https://github.com/software-mansion/cairols" },
            { icon: "twitter", link: "https://twitter.com/swmansionxyz" },
            {
                ...
                ariaLabel: "Telegram",
                link: "https://t.me/cairo_ls_support",
            },
        ],
    },
