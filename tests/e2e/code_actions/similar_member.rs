...
fn add_1_char_typo_multiple_members() {
    ...
    At: Range { start: Position { line: 8, character: 15 }, end: Position { line: 8, character: 27 } }
...
fn trait_function_body_member_typo() {
    ...
    Title: Use membero instead
    Add new text: "membero"
    At: Range { start: Position { line: 10, character: 15 }, end: Position { line: 10, character: 21 } }
    "#);
}
...
fn impl_function_body_member_typo() {
    ...
    Title: Use membero instead
    Add new text: "membero"
    At: Range { start: Position { line: 9, character: 15 }, end: Position { line: 9, character: 23 } }
    "#);
}
...
fn nested_member_typo() {
    ...
    Add new text: "foo"
    At: Range { start: Position { line: 6, character: 26 }, end: Position { line: 6, character: 29 } }
    "#);
}
