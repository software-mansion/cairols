...
use lsp_types::{
    ...
    ExecuteCommandParams, Hover, HoverClientCapabilities, HoverContents, HoverParams,
    MarkupContent, MarkupKind, Range, TextDocumentClientCapabilities, TextDocumentPositionParams,
    Url, lsp_request,
};
use serde::Serialize;

use crate::support::cairo_project_toml::CAIRO_PROJECT_TOML_2024_07;
use crate::support::cursor::{Cursor, peek_caret, peek_selection};
