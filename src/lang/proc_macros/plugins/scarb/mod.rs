...
fn into_cairo_diagnostics(
    diagnostics: Vec<cairo_lang_macro_v1::Diagnostic>,
    ...
    diagnostics
        ...
        .map(|diag| PluginDiagnostic {
            ...
            severity: match diag.severity {
                SeverityV1::Error => cairo_lang_diagnostics::Severity::Error,
                SeverityV1::Warning => cairo_lang_diagnostics::Severity::Warning,
            },
        })
        .collect()
}
