...
impl ProjectModel {
    ...
    pub fn apply_changes_to_db(
        ...
        for cr in merged_crates {
            ...
            let changed =
                previous_plugin_suite_fingerprints.get(&cr_input) != Some(&fingerprint);
        ...
        self.applied_plugin_suite_fingerprints = Owned::new(Arc::new(next_plugin_suite_fingerprints));
    }
